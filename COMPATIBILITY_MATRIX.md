...
- Xbox support is limited to the checked-in macOS/browser compatibility evidence
  ...
  cache cleanup can restore Generic BLE HID visibility, not that Generic
  browser replay, automatic persona switching, or reconnect robustness is
  solved.
