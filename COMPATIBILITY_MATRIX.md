...
- Xbox support is limited to the checked-in macOS/browser compatibility evidence
  ...
  it proves stale browser slots are detected/rejected, not that no-human Generic
  browser replay or reconnect robustness is solved.
